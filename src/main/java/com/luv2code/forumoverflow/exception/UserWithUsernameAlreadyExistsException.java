...
public class UserWithUsernameAlreadyExistsException extends AbstractEntityException {

	private static final long serialVersionUID = 1L;

	public UserWithUsernameAlreadyExistsException(String entityName, String fieldName, String fieldValue) {
		super(entityName, fieldName, fieldValue, null);
	}

	public UserWithUsernameAlreadyExistsException(String entityName, String fieldName, String fieldValue, Throwable cause) {
